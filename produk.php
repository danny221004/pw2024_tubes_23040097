...
<body>
  ...
  <div class="container mt-5 w-50">
    <form class="input-group w-auto ms-lg-3 my-3 my-lg-0">
      <input type="search" class="form-control" name="keyword" id="search" placeholder="Cari Produk..." aria-label="Search" />
